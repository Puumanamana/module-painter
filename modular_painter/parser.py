...
def parse_args():
    ...
    parser.add_argument('--min-hsp-len', type=int, default=40, help='Minimum HSP length in BLAST alignments')
    parser.add_argument('--min-module-size', type=int, default=40, help='Maximum distance between modules to consider them contiguous.')
    parser.add_argument('--arc-eq-diffs', type=int, default=3, help='Maximum distance between embedded modules to consider them identical.')            
